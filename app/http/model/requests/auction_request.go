...
type AuctionRequest struct {
	...
	HandlingChargeDailyGold   int     ` json:"handlingchargedailygold"`
	HandlingChargeDailyCoin   int     ` json:"handlingchargedailycoin"`
	HandlingChargeDailyCopper int     ` json:"handlingchargedailycopper"`
