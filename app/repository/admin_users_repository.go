...
var adminUsersRepository = newAdminUsersRepository()

func newAdminUsersRepository() *AdminUsersRepository {
	return new(AdminUsersRepository)
}

func (repo *AdminUsersRepository) Insert(m *model.AdminUsers) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *AdminUsersRepository) Update(m *model.AdminUsers) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdminUsersRepository) First(m *model.AdminUsers, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdminUsersRepository) DeleteByLocation(m *model.AdminUsers) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
// 事务
func (repo *AdminUsersRepository) TransactionExecute(fun func() error, opts ...*sql.TxOptions) (e error) {
...
func (repo *AdminUsersRepository) SaveInRedis(m *model.AdminUsers) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *AdminUsersRepository) FindInRedis(m *model.AdminUsers) (e error) {
	defer func() {
...
func (repo *AdminUsersRepository) FindInRedisByKey(redisKey string) (redisRes string, e error) {
	defer func() {
		if e != nil && e != redis.Nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *AdminUsersRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *AdminUsersRepository) DeleteInRedis(m *model.AdminUsers) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *AdminUsersRepository) GetDataListByWhereMap(query map[string]interface{}, preload []string) (list []*model.AdminUsers, e error) {
	m := &model.AdminUsers{}
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *AdminUsersRepository) GetDataListByWhere(query string, args []interface{}, preload []string) (list []*model.AdminUsers, e error) {
	now := time.Now()
	m := &model.AdminUsers{}
	defer func() {
		if e != nil {
...
func (repo *AdminUsersRepository) GetDataByWhereMap(m *model.AdminUsers, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdminUsersRepository) Execute(db *gorm.DB, object interface{}) error {
...
func (repo *AdminUsersRepository) GetTotalPage(db *gorm.DB) (e error) {
