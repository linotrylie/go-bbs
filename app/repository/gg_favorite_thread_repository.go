...
func (repo *GgFavoriteThreadRepository) Insert(m *model.GgFavoriteThread) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *GgFavoriteThreadRepository) Update(m *model.GgFavoriteThread) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *GgFavoriteThreadRepository) First(m *model.GgFavoriteThread, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *GgFavoriteThreadRepository) DeleteByLocation(m *model.GgFavoriteThread) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *GgFavoriteThreadRepository) SaveInRedis(m *model.GgFavoriteThread) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *GgFavoriteThreadRepository) FindInRedis(m *model.GgFavoriteThread) (e error) {
	defer func() {
...
func (repo *GgFavoriteThreadRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *GgFavoriteThreadRepository) DeleteInRedis(m *model.GgFavoriteThread) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *GgFavoriteThreadRepository) GetDataByWhereMap(m *model.GgFavoriteThread, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *GgFavoriteThreadRepository) GetTotalPage(db *gorm.DB) (e error) {
