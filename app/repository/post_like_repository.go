...
func (repo *PostLikeRepository) Insert(m *model.PostLike) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *PostLikeRepository) Update(m *model.PostLike) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *PostLikeRepository) First(m *model.PostLike, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *PostLikeRepository) DeleteByLocation(m *model.PostLike) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *PostLikeRepository) SaveInRedis(m *model.PostLike) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *PostLikeRepository) FindInRedis(m *model.PostLike) (e error) {
	defer func() {
...
func (repo *PostLikeRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *PostLikeRepository) DeleteInRedis(m *model.PostLike) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *PostLikeRepository) GetDataByWhereMap(m *model.PostLike, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
