...
func (repo *OperationLogRepository) Insert(m *model.OperationLog) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *OperationLogRepository) Update(m *model.OperationLog) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *OperationLogRepository) First(m *model.OperationLog, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *OperationLogRepository) DeleteByLocation(m *model.OperationLog) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *OperationLogRepository) SaveInRedis(m *model.OperationLog) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *OperationLogRepository) FindInRedis(m *model.OperationLog) (e error) {
	defer func() {
...
func (repo *OperationLogRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *OperationLogRepository) DeleteInRedis(m *model.OperationLog) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *OperationLogRepository) GetDataByWhereMap(m *model.OperationLog, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
