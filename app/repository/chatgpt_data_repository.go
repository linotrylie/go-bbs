...
type ChatgptDataRepository struct {
	Pager *Pager
}

var chatgptDataRepository = newChatgptDataRepository()

func newChatgptDataRepository() *ChatgptDataRepository {
	return new(ChatgptDataRepository)
}

func (repo *ChatgptDataRepository) Insert(m *model.ChatgptData) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *ChatgptDataRepository) Update(m *model.ChatgptData) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *ChatgptDataRepository) First(m *model.ChatgptData, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *ChatgptDataRepository) DeleteByLocation(m *model.ChatgptData) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
// 事务
func (repo *ChatgptDataRepository) TransactionExecute(fun func() error, opts ...*sql.TxOptions) (e error) {
...
func (repo *ChatgptDataRepository) SaveInRedis(m *model.ChatgptData) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *ChatgptDataRepository) FindInRedis(m *model.ChatgptData) (e error) {
	defer func() {
...
func (repo *ChatgptDataRepository) FindInRedisByKey(redisKey string) (redisRes string, e error) {
	defer func() {
		if e != nil && e != redis.Nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *ChatgptDataRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *ChatgptDataRepository) DeleteInRedis(m *model.ChatgptData) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *ChatgptDataRepository) GetDataListByWhereMap(query map[string]interface{}, preload []string) (list []*model.ChatgptData, e error) {
	m := &model.ChatgptData{}
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *ChatgptDataRepository) GetDataListByWhere(query string, args []interface{}, preload []string) (list []*model.ChatgptData, e error) {
	now := time.Now()
	m := &model.ChatgptData{}
	defer func() {
		if e != nil {
...
func (repo *ChatgptDataRepository) GetDataByWhereMap(m *model.ChatgptData, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *ChatgptDataRepository) Execute(db *gorm.DB, object interface{}) error {
...
func (repo *ChatgptDataRepository) GetTotalPage(db *gorm.DB) (e error) {
