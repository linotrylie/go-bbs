...
func (repo *MythreadRepository) Insert(m *model.Mythread) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *MythreadRepository) Update(m *model.Mythread) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *MythreadRepository) First(m *model.Mythread, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *MythreadRepository) DeleteByLocation(m *model.Mythread) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *MythreadRepository) SaveInRedis(m *model.Mythread) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *MythreadRepository) FindInRedis(m *model.Mythread) (e error) {
	defer func() {
...
func (repo *MythreadRepository) DeleteInRedis(m *model.Mythread) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *MythreadRepository) GetDataByWhereMap(m *model.Mythread, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
