...
func (repo *IpaccessRepository) Insert(m *model.Ipaccess) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *IpaccessRepository) Update(m *model.Ipaccess) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *IpaccessRepository) First(m *model.Ipaccess, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *IpaccessRepository) DeleteByLocation(m *model.Ipaccess) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *IpaccessRepository) SaveInRedis(m *model.Ipaccess) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *IpaccessRepository) FindInRedis(m *model.Ipaccess) (e error) {
	defer func() {
...
func (repo *IpaccessRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *IpaccessRepository) DeleteInRedis(m *model.Ipaccess) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *IpaccessRepository) GetDataByWhereMap(m *model.Ipaccess, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
