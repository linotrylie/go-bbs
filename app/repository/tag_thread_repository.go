...
func (repo *TagThreadRepository) Insert(m *model.TagThread) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *TagThreadRepository) Update(m *model.TagThread) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *TagThreadRepository) First(m *model.TagThread, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *TagThreadRepository) DeleteByLocation(m *model.TagThread) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *TagThreadRepository) SaveInRedis(m *model.TagThread) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *TagThreadRepository) FindInRedis(m *model.TagThread) (e error) {
	defer func() {
...
func (repo *TagThreadRepository) DeleteInRedis(m *model.TagThread) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *TagThreadRepository) GetDataByWhereMap(m *model.TagThread, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
