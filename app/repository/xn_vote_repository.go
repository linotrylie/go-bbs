...
func (repo *XnVoteRepository) Insert(m *model.XnVote) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *XnVoteRepository) Update(m *model.XnVote) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *XnVoteRepository) First(m *model.XnVote, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *XnVoteRepository) DeleteByLocation(m *model.XnVote) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *XnVoteRepository) SaveInRedis(m *model.XnVote) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *XnVoteRepository) FindInRedis(m *model.XnVote) (e error) {
	defer func() {
...
func (repo *XnVoteRepository) DeleteInRedis(m *model.XnVote) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *XnVoteRepository) GetDataByWhereMap(m *model.XnVote, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
