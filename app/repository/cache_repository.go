...
func (repo *CacheRepository) Insert(m *model.Cache) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *CacheRepository) Update(m *model.Cache) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *CacheRepository) First(m *model.Cache, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *CacheRepository) DeleteByLocation(m *model.Cache) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *CacheRepository) SaveInRedis(m *model.Cache) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *CacheRepository) FindInRedis(m *model.Cache) (e error) {
	defer func() {
...
func (repo *CacheRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *CacheRepository) DeleteInRedis(m *model.Cache) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *CacheRepository) GetDataByWhereMap(m *model.Cache, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
