...
func (repo *XnVoteInfoRepository) Insert(m *model.XnVoteInfo) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *XnVoteInfoRepository) Update(m *model.XnVoteInfo) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *XnVoteInfoRepository) First(m *model.XnVoteInfo, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *XnVoteInfoRepository) DeleteByLocation(m *model.XnVoteInfo) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *XnVoteInfoRepository) SaveInRedis(m *model.XnVoteInfo) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *XnVoteInfoRepository) FindInRedis(m *model.XnVoteInfo) (e error) {
	defer func() {
...
func (repo *XnVoteInfoRepository) DeleteInRedis(m *model.XnVoteInfo) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *XnVoteInfoRepository) GetDataByWhereMap(m *model.XnVoteInfo, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
