...
func (repo *WsThreadPayRepository) Insert(m *model.WsThreadPay) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *WsThreadPayRepository) Update(m *model.WsThreadPay) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *WsThreadPayRepository) First(m *model.WsThreadPay, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *WsThreadPayRepository) DeleteByLocation(m *model.WsThreadPay) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *WsThreadPayRepository) SaveInRedis(m *model.WsThreadPay) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *WsThreadPayRepository) FindInRedis(m *model.WsThreadPay) (e error) {
	defer func() {
...
func (repo *WsThreadPayRepository) DeleteInRedis(m *model.WsThreadPay) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *WsThreadPayRepository) GetDataByWhereMap(m *model.WsThreadPay, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
