...
func (repo *SessionDataRepository) Insert(m *model.SessionData) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *SessionDataRepository) Update(m *model.SessionData) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *SessionDataRepository) First(m *model.SessionData, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *SessionDataRepository) DeleteByLocation(m *model.SessionData) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *SessionDataRepository) SaveInRedis(m *model.SessionData) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *SessionDataRepository) FindInRedis(m *model.SessionData) (e error) {
	defer func() {
...
func (repo *SessionDataRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *SessionDataRepository) DeleteInRedis(m *model.SessionData) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *SessionDataRepository) GetDataByWhereMap(m *model.SessionData, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *SessionDataRepository) GetTotalPage(db *gorm.DB) (e error) {
