...
func (repo *TagCateRepository) Insert(m *model.TagCate) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *TagCateRepository) Update(m *model.TagCate) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *TagCateRepository) First(m *model.TagCate, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *TagCateRepository) DeleteByLocation(m *model.TagCate) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *TagCateRepository) SaveInRedis(m *model.TagCate) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *TagCateRepository) FindInRedis(m *model.TagCate) (e error) {
	defer func() {
...
func (repo *TagCateRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *TagCateRepository) DeleteInRedis(m *model.TagCate) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *TagCateRepository) GetDataByWhereMap(m *model.TagCate, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *TagCateRepository) GetTotalPage(db *gorm.DB) (e error) {
