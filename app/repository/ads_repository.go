...
var adsRepository = newAdsRepository()

func newAdsRepository() *AdsRepository {
	return new(AdsRepository)
}

func (repo *AdsRepository) Insert(m *model.Ads) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *AdsRepository) Update(m *model.Ads) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdsRepository) First(m *model.Ads, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdsRepository) DeleteByLocation(m *model.Ads) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
// 事务
func (repo *AdsRepository) TransactionExecute(fun func() error, opts ...*sql.TxOptions) (e error) {
...
func (repo *AdsRepository) SaveInRedis(m *model.Ads) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *AdsRepository) FindInRedis(m *model.Ads) (e error) {
	defer func() {
...
func (repo *AdsRepository) FindInRedisByKey(redisKey string) (redisRes string, e error) {
	defer func() {
		if e != nil && e != redis.Nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *AdsRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *AdsRepository) DeleteInRedis(m *model.Ads) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *AdsRepository) GetDataListByWhereMap(query map[string]interface{}, preload []string) (list []*model.Ads, e error) {
	m := &model.Ads{}
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *AdsRepository) GetDataListByWhere(query string, args []interface{}, preload []string) (list []*model.Ads, e error) {
	now := time.Now()
	m := &model.Ads{}
	defer func() {
		if e != nil {
...
func (repo *AdsRepository) GetDataByWhereMap(m *model.Ads, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdsRepository) Execute(db *gorm.DB, object interface{}) error {
...
func (repo *AdsRepository) GetTotalPage(db *gorm.DB) (e error) {
