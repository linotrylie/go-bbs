...
var failedJobsRepository = newFailedJobsRepository()

func newFailedJobsRepository() *FailedJobsRepository {
	return new(FailedJobsRepository)
}

func (repo *FailedJobsRepository) Insert(m *model.FailedJobs) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *FailedJobsRepository) Update(m *model.FailedJobs) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *FailedJobsRepository) First(m *model.FailedJobs, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *FailedJobsRepository) DeleteByLocation(m *model.FailedJobs) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
// 事务
func (repo *FailedJobsRepository) TransactionExecute(fun func() error, opts ...*sql.TxOptions) (e error) {
...
func (repo *FailedJobsRepository) SaveInRedis(m *model.FailedJobs) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *FailedJobsRepository) FindInRedis(m *model.FailedJobs) (e error) {
	defer func() {
...
func (repo *FailedJobsRepository) FindInRedisByKey(redisKey string) (redisRes string, e error) {
	defer func() {
		if e != nil && e != redis.Nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *FailedJobsRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *FailedJobsRepository) DeleteInRedis(m *model.FailedJobs) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *FailedJobsRepository) GetDataListByWhereMap(query map[string]interface{}, preload []string) (list []*model.FailedJobs, e error) {
	m := &model.FailedJobs{}
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *FailedJobsRepository) GetDataListByWhere(query string, args []interface{}, preload []string) (list []*model.FailedJobs, e error) {
	now := time.Now()
	m := &model.FailedJobs{}
	defer func() {
		if e != nil {
...
func (repo *FailedJobsRepository) GetDataByWhereMap(m *model.FailedJobs, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *FailedJobsRepository) Execute(db *gorm.DB, object interface{}) error {
...
func (repo *FailedJobsRepository) GetTotalPage(db *gorm.DB) (e error) {
