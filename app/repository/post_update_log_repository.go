...
func (repo *PostUpdateLogRepository) Insert(m *model.PostUpdateLog) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *PostUpdateLogRepository) Update(m *model.PostUpdateLog) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *PostUpdateLogRepository) First(m *model.PostUpdateLog, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *PostUpdateLogRepository) DeleteByLocation(m *model.PostUpdateLog) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *PostUpdateLogRepository) SaveInRedis(m *model.PostUpdateLog) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *PostUpdateLogRepository) FindInRedis(m *model.PostUpdateLog) (e error) {
	defer func() {
...
func (repo *PostUpdateLogRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *PostUpdateLogRepository) DeleteInRedis(m *model.PostUpdateLog) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *PostUpdateLogRepository) GetDataByWhereMap(m *model.PostUpdateLog, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
