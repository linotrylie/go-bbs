...
type BuyCardRepository struct {
	Pager *Pager
}

var buyCardRepository = newBuyCardRepository()

func newBuyCardRepository() *BuyCardRepository {
	return new(BuyCardRepository)
}

func (repo *BuyCardRepository) Insert(m *model.BuyCard) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *BuyCardRepository) Update(m *model.BuyCard) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *BuyCardRepository) First(m *model.BuyCard, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *BuyCardRepository) DeleteByLocation(m *model.BuyCard) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
// 事务
func (repo *BuyCardRepository) TransactionExecute(fun func() error, opts ...*sql.TxOptions) (e error) {
...
func (repo *BuyCardRepository) SaveInRedis(m *model.BuyCard) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *BuyCardRepository) FindInRedis(m *model.BuyCard) (e error) {
	defer func() {
...
func (repo *BuyCardRepository) FindInRedisByKey(redisKey string) (redisRes string, e error) {
	defer func() {
		if e != nil && e != redis.Nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *BuyCardRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *BuyCardRepository) DeleteInRedis(m *model.BuyCard) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *BuyCardRepository) GetDataListByWhereMap(query map[string]interface{}, preload []string) (list []*model.BuyCard, e error) {
	m := &model.BuyCard{}
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *BuyCardRepository) GetDataListByWhere(query string, args []interface{}, preload []string) (list []*model.BuyCard, e error) {
	now := time.Now()
	m := &model.BuyCard{}
	defer func() {
		if e != nil {
...
func (repo *BuyCardRepository) GetDataByWhereMap(m *model.BuyCard, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *BuyCardRepository) Execute(db *gorm.DB, object interface{}) error {
...
func (repo *BuyCardRepository) GetTotalPage(db *gorm.DB) (e error) {
