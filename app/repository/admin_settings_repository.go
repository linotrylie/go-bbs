...
var adminSettingsRepository = newAdminSettingsRepository()

func newAdminSettingsRepository() *AdminSettingsRepository {
	return new(AdminSettingsRepository)
}

func (repo *AdminSettingsRepository) Insert(m *model.AdminSettings) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *AdminSettingsRepository) Update(m *model.AdminSettings) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdminSettingsRepository) First(m *model.AdminSettings, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdminSettingsRepository) DeleteByLocation(m *model.AdminSettings) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
// 事务
func (repo *AdminSettingsRepository) TransactionExecute(fun func() error, opts ...*sql.TxOptions) (e error) {
...
func (repo *AdminSettingsRepository) SaveInRedis(m *model.AdminSettings) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *AdminSettingsRepository) FindInRedis(m *model.AdminSettings) (e error) {
	defer func() {
...
func (repo *AdminSettingsRepository) FindInRedisByKey(redisKey string) (redisRes string, e error) {
	defer func() {
		if e != nil && e != redis.Nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *AdminSettingsRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *AdminSettingsRepository) DeleteInRedis(m *model.AdminSettings) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *AdminSettingsRepository) GetDataListByWhereMap(query map[string]interface{}, preload []string) (list []*model.AdminSettings, e error) {
	m := &model.AdminSettings{}
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdminSettingsRepository) GetDataListByWhere(query string, args []interface{}, preload []string) (list []*model.AdminSettings, e error) {
	now := time.Now()
	m := &model.AdminSettings{}
	defer func() {
		if e != nil {
...
func (repo *AdminSettingsRepository) GetDataByWhereMap(m *model.AdminSettings, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdminSettingsRepository) Execute(db *gorm.DB, object interface{}) error {
...
func (repo *AdminSettingsRepository) GetTotalPage(db *gorm.DB) (e error) {
