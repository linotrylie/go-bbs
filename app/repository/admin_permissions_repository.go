...
var adminPermissionsRepository = newAdminPermissionsRepository()

func newAdminPermissionsRepository() *AdminPermissionsRepository {
	return new(AdminPermissionsRepository)
}

func (repo *AdminPermissionsRepository) Insert(m *model.AdminPermissions) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *AdminPermissionsRepository) Update(m *model.AdminPermissions) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdminPermissionsRepository) First(m *model.AdminPermissions, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdminPermissionsRepository) DeleteByLocation(m *model.AdminPermissions) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
// 事务
func (repo *AdminPermissionsRepository) TransactionExecute(fun func() error, opts ...*sql.TxOptions) (e error) {
...
func (repo *AdminPermissionsRepository) SaveInRedis(m *model.AdminPermissions) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *AdminPermissionsRepository) FindInRedis(m *model.AdminPermissions) (e error) {
	defer func() {
...
func (repo *AdminPermissionsRepository) FindInRedisByKey(redisKey string) (redisRes string, e error) {
	defer func() {
		if e != nil && e != redis.Nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *AdminPermissionsRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *AdminPermissionsRepository) DeleteInRedis(m *model.AdminPermissions) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *AdminPermissionsRepository) GetDataListByWhereMap(query map[string]interface{}, preload []string) (list []*model.AdminPermissions, e error) {
	m := &model.AdminPermissions{}
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdminPermissionsRepository) GetDataListByWhere(query string, args []interface{}, preload []string) (list []*model.AdminPermissions, e error) {
	now := time.Now()
	m := &model.AdminPermissions{}
	defer func() {
		if e != nil {
...
func (repo *AdminPermissionsRepository) GetDataByWhereMap(m *model.AdminPermissions, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdminPermissionsRepository) Execute(db *gorm.DB, object interface{}) error {
...
func (repo *AdminPermissionsRepository) GetTotalPage(db *gorm.DB) (e error) {
