...
func (repo *SlideRepository) Insert(m *model.Slide) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *SlideRepository) Update(m *model.Slide) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *SlideRepository) First(m *model.Slide, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *SlideRepository) DeleteByLocation(m *model.Slide) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *SlideRepository) SaveInRedis(m *model.Slide) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *SlideRepository) FindInRedis(m *model.Slide) (e error) {
	defer func() {
...
func (repo *SlideRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *SlideRepository) DeleteInRedis(m *model.Slide) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *SlideRepository) GetDataByWhereMap(m *model.Slide, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
