...
func (repo *ModlogRepository) Insert(m *model.Modlog) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *ModlogRepository) Update(m *model.Modlog) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *ModlogRepository) First(m *model.Modlog, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *ModlogRepository) DeleteByLocation(m *model.Modlog) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *ModlogRepository) SaveInRedis(m *model.Modlog) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *ModlogRepository) FindInRedis(m *model.Modlog) (e error) {
	defer func() {
...
func (repo *ModlogRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *ModlogRepository) DeleteInRedis(m *model.Modlog) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *ModlogRepository) GetDataByWhereMap(m *model.Modlog, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
