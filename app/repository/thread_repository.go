...
func (repo *ThreadRepository) Insert(m *model.Thread) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *ThreadRepository) Update(m *model.Thread) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *ThreadRepository) First(m *model.Thread, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *ThreadRepository) DeleteByLocation(m *model.Thread) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *ThreadRepository) SaveInRedis(m *model.Thread) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *ThreadRepository) FindInRedis(m *model.Thread) (e error) {
	defer func() {
...
func (repo *ThreadRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *ThreadRepository) DeleteInRedis(m *model.Thread) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *ThreadRepository) GetDataListByWhereMap(query map[string]interface{}, preload []string) (list []*model.Thread, e error) {
	m := &model.Thread{}
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *ThreadRepository) GetDataListByWhere(query string, args []interface{}, preload []string) (list []*model.Thread, e error) {
	now := time.Now()
	m := &model.Thread{}
	defer func() {
		if e != nil {
...
func (repo *ThreadRepository) GetDataByWhereMap(m *model.Thread, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *ThreadRepository) GetTotalPage(db *gorm.DB) (e error) {
