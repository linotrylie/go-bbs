...
func (repo *QueueRepository) Insert(m *model.Queue) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *QueueRepository) Update(m *model.Queue) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *QueueRepository) First(m *model.Queue, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *QueueRepository) DeleteByLocation(m *model.Queue) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *QueueRepository) SaveInRedis(m *model.Queue) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *QueueRepository) FindInRedis(m *model.Queue) (e error) {
	defer func() {
...
func (repo *QueueRepository) DeleteInRedis(m *model.Queue) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *QueueRepository) GetDataByWhereMap(m *model.Queue, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
