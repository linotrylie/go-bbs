...
func (repo *PostSearchRepository) Insert(m *model.PostSearch) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *PostSearchRepository) Update(m *model.PostSearch) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *PostSearchRepository) First(m *model.PostSearch, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *PostSearchRepository) DeleteByLocation(m *model.PostSearch) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *PostSearchRepository) SaveInRedis(m *model.PostSearch) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *PostSearchRepository) FindInRedis(m *model.PostSearch) (e error) {
	defer func() {
...
func (repo *PostSearchRepository) DeleteInRedis(m *model.PostSearch) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *PostSearchRepository) GetDataByWhereMap(m *model.PostSearch, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
