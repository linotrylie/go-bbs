...
func (repo *TagRepository) Insert(m *model.Tag) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *TagRepository) Update(m *model.Tag) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *TagRepository) First(m *model.Tag, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *TagRepository) DeleteByLocation(m *model.Tag) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *TagRepository) SaveInRedis(m *model.Tag) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *TagRepository) FindInRedis(m *model.Tag) (e error) {
	defer func() {
...
func (repo *TagRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *TagRepository) DeleteInRedis(m *model.Tag) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *TagRepository) GetDataByWhereMap(m *model.Tag, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
