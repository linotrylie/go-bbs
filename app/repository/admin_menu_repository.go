...
var adminMenuRepository = newAdminMenuRepository()

func newAdminMenuRepository() *AdminMenuRepository {
	return new(AdminMenuRepository)
}

func (repo *AdminMenuRepository) Insert(m *model.AdminMenu) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *AdminMenuRepository) Update(m *model.AdminMenu) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdminMenuRepository) First(m *model.AdminMenu, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdminMenuRepository) DeleteByLocation(m *model.AdminMenu) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
// 事务
func (repo *AdminMenuRepository) TransactionExecute(fun func() error, opts ...*sql.TxOptions) (e error) {
...
func (repo *AdminMenuRepository) SaveInRedis(m *model.AdminMenu) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *AdminMenuRepository) FindInRedis(m *model.AdminMenu) (e error) {
	defer func() {
...
func (repo *AdminMenuRepository) FindInRedisByKey(redisKey string) (redisRes string, e error) {
	defer func() {
		if e != nil && e != redis.Nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *AdminMenuRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *AdminMenuRepository) DeleteInRedis(m *model.AdminMenu) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *AdminMenuRepository) GetDataListByWhereMap(query map[string]interface{}, preload []string) (list []*model.AdminMenu, e error) {
	m := &model.AdminMenu{}
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *AdminMenuRepository) GetDataListByWhere(query string, args []interface{}, preload []string) (list []*model.AdminMenu, e error) {
	now := time.Now()
	m := &model.AdminMenu{}
	defer func() {
		if e != nil {
...
func (repo *AdminMenuRepository) GetDataByWhereMap(m *model.AdminMenu, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdminMenuRepository) Execute(db *gorm.DB, object interface{}) error {
...
func (repo *AdminMenuRepository) GetTotalPage(db *gorm.DB) (e error) {
