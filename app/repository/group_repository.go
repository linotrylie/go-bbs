...
func (repo *GroupRepository) Insert(m *model.Group) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *GroupRepository) Update(m *model.Group) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *GroupRepository) First(m *model.Group, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *GroupRepository) DeleteByLocation(m *model.Group) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *GroupRepository) SaveInRedis(m *model.Group) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *GroupRepository) FindInRedis(m *model.Group) (e error) {
	defer func() {
...
func (repo *GroupRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *GroupRepository) DeleteInRedis(m *model.Group) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *GroupRepository) GetDataByWhereMap(m *model.Group, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *GroupRepository) GetTotalPage(db *gorm.DB) (e error) {
