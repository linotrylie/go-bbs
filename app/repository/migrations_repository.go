...
var migrationsRepository = newMigrationsRepository()

func newMigrationsRepository() *MigrationsRepository {
	return new(MigrationsRepository)
}

func (repo *MigrationsRepository) Insert(m *model.Migrations) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *MigrationsRepository) Update(m *model.Migrations) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *MigrationsRepository) First(m *model.Migrations, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *MigrationsRepository) DeleteByLocation(m *model.Migrations) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
// 事务
func (repo *MigrationsRepository) TransactionExecute(fun func() error, opts ...*sql.TxOptions) (e error) {
...
func (repo *MigrationsRepository) SaveInRedis(m *model.Migrations) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *MigrationsRepository) FindInRedis(m *model.Migrations) (e error) {
	defer func() {
...
func (repo *MigrationsRepository) FindInRedisByKey(redisKey string) (redisRes string, e error) {
	defer func() {
		if e != nil && e != redis.Nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *MigrationsRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *MigrationsRepository) DeleteInRedis(m *model.Migrations) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *MigrationsRepository) GetDataListByWhereMap(query map[string]interface{}, preload []string) (list []*model.Migrations, e error) {
	m := &model.Migrations{}
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *MigrationsRepository) GetDataListByWhere(query string, args []interface{}, preload []string) (list []*model.Migrations, e error) {
	now := time.Now()
	m := &model.Migrations{}
	defer func() {
		if e != nil {
...
func (repo *MigrationsRepository) GetDataByWhereMap(m *model.Migrations, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *MigrationsRepository) Execute(db *gorm.DB, object interface{}) error {
...
func (repo *MigrationsRepository) GetTotalPage(db *gorm.DB) (e error) {
