...
func (repo *SgSignRepository) Insert(m *model.SgSign) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *SgSignRepository) Update(m *model.SgSign) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *SgSignRepository) First(m *model.SgSign, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *SgSignRepository) DeleteByLocation(m *model.SgSign) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *SgSignRepository) SaveInRedis(m *model.SgSign) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *SgSignRepository) FindInRedis(m *model.SgSign) (e error) {
	defer func() {
...
func (repo *SgSignRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *SgSignRepository) DeleteInRedis(m *model.SgSign) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *SgSignRepository) GetDataByWhereMap(m *model.SgSign, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *SgSignRepository) GetTotalPage(db *gorm.DB) (e error) {
