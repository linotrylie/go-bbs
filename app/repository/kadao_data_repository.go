...
func (repo *KadaoDataRepository) Insert(m *model.KadaoData) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *KadaoDataRepository) Update(m *model.KadaoData) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *KadaoDataRepository) First(m *model.KadaoData, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *KadaoDataRepository) DeleteByLocation(m *model.KadaoData) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *KadaoDataRepository) SaveInRedis(m *model.KadaoData) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *KadaoDataRepository) FindInRedis(m *model.KadaoData) (e error) {
	defer func() {
...
func (repo *KadaoDataRepository) DeleteInRedis(m *model.KadaoData) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *KadaoDataRepository) GetDataByWhereMap(m *model.KadaoData, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
