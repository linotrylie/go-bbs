...
func (repo *ThreadDigestRepository) Insert(m *model.ThreadDigest) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *ThreadDigestRepository) Update(m *model.ThreadDigest) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *ThreadDigestRepository) First(m *model.ThreadDigest, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *ThreadDigestRepository) DeleteByLocation(m *model.ThreadDigest) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *ThreadDigestRepository) SaveInRedis(m *model.ThreadDigest) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *ThreadDigestRepository) FindInRedis(m *model.ThreadDigest) (e error) {
	defer func() {
...
func (repo *ThreadDigestRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *ThreadDigestRepository) DeleteInRedis(m *model.ThreadDigest) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *ThreadDigestRepository) GetDataByWhereMap(m *model.ThreadDigest, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
