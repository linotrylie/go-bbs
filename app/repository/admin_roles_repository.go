...
type AdminRolesRepository struct {
	Pager *Pager
}

var adminRolesRepository = newAdminRolesRepository()

func newAdminRolesRepository() *AdminRolesRepository {
	return new(AdminRolesRepository)
}

func (repo *AdminRolesRepository) Insert(m *model.AdminRoles) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *AdminRolesRepository) Update(m *model.AdminRoles) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdminRolesRepository) First(m *model.AdminRoles, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdminRolesRepository) DeleteByLocation(m *model.AdminRoles) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
// 事务
func (repo *AdminRolesRepository) TransactionExecute(fun func() error, opts ...*sql.TxOptions) (e error) {
...
func (repo *AdminRolesRepository) SaveInRedis(m *model.AdminRoles) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *AdminRolesRepository) FindInRedis(m *model.AdminRoles) (e error) {
	defer func() {
...
func (repo *AdminRolesRepository) FindInRedisByKey(redisKey string) (redisRes string, e error) {
	defer func() {
		if e != nil && e != redis.Nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *AdminRolesRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *AdminRolesRepository) DeleteInRedis(m *model.AdminRoles) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *AdminRolesRepository) GetDataListByWhereMap(query map[string]interface{}, preload []string) (list []*model.AdminRoles, e error) {
	m := &model.AdminRoles{}
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *AdminRolesRepository) GetDataListByWhere(query string, args []interface{}, preload []string) (list []*model.AdminRoles, e error) {
	now := time.Now()
	m := &model.AdminRoles{}
	defer func() {
		if e != nil {
...
func (repo *AdminRolesRepository) GetDataByWhereMap(m *model.AdminRoles, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *AdminRolesRepository) Execute(db *gorm.DB, object interface{}) error {
...
func (repo *AdminRolesRepository) GetTotalPage(db *gorm.DB) (e error) {
