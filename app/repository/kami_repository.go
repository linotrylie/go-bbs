...
func (repo *KamiRepository) Insert(m *model.Kami) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *KamiRepository) Update(m *model.Kami) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *KamiRepository) First(m *model.Kami, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *KamiRepository) DeleteByLocation(m *model.Kami) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *KamiRepository) SaveInRedis(m *model.Kami) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *KamiRepository) FindInRedis(m *model.Kami) (e error) {
	defer func() {
...
func (repo *KamiRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *KamiRepository) DeleteInRedis(m *model.Kami) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *KamiRepository) GetDataByWhereMap(m *model.Kami, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
