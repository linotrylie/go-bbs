...
var chatgptRepository = newChatgptRepository()

func newChatgptRepository() *ChatgptRepository {
	return new(ChatgptRepository)
}

func (repo *ChatgptRepository) Insert(m *model.Chatgpt) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *ChatgptRepository) Update(m *model.Chatgpt) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *ChatgptRepository) First(m *model.Chatgpt, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *ChatgptRepository) DeleteByLocation(m *model.Chatgpt) (rowsAffected int64, e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
// 事务
func (repo *ChatgptRepository) TransactionExecute(fun func() error, opts ...*sql.TxOptions) (e error) {
...
func (repo *ChatgptRepository) SaveInRedis(m *model.Chatgpt) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *ChatgptRepository) FindInRedis(m *model.Chatgpt) (e error) {
	defer func() {
...
func (repo *ChatgptRepository) FindInRedisByKey(redisKey string) (redisRes string, e error) {
	defer func() {
		if e != nil && e != redis.Nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *ChatgptRepository) SaveInRedisByKey(redisKey string, data string, timeout int) {
...
func (repo *ChatgptRepository) DeleteInRedis(m *model.Chatgpt) (e error) {
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
		}
...
func (repo *ChatgptRepository) GetDataListByWhereMap(query map[string]interface{}, preload []string) (list []*model.Chatgpt, e error) {
	m := &model.Chatgpt{}
	now := time.Now()
	defer func() {
		if e != nil {
...
func (repo *ChatgptRepository) GetDataListByWhere(query string, args []interface{}, preload []string) (list []*model.Chatgpt, e error) {
	now := time.Now()
	m := &model.Chatgpt{}
	defer func() {
		if e != nil {
...
func (repo *ChatgptRepository) GetDataByWhereMap(m *model.Chatgpt, where map[string]interface{}, preload []string) (e error) {
	now := time.Now()
	defer func() {
		if e != nil {
			global.LOG.Error(e.Error(), zap.Error(e))
...
func (repo *ChatgptRepository) Execute(db *gorm.DB, object interface{}) error {
...
func (repo *ChatgptRepository) GetTotalPage(db *gorm.DB) (e error) {
